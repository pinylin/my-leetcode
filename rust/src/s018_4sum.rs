...
mod test {
    ...
    fn it_works() {
            ...
            assert_eq!(Solution::four_sum(vec![1, 0, -1, 0, -2, 2], 3), vec![
                       vec![0,  0, 1, 2]
            ]);
 

            assert_eq!(Solution::four_sum(vec![1, 0, -1, 0], 0), vec![
                vec![-1,  0, 0, 1],
            ]);
            ...
            assert_eq!(Solution::four_sum(vec![1, 0, -1, -1, -1, -1, -1], -4), vec![
                vec![-1, -1, -1, -1]
            ]);
   
            assert_eq!(Solution::four_sum(vec![-5,-4,-3,-2,-1,0,0,1,2,3,4,5], 0), vec![
            ...
            assert_eq!(Solution::four_sum(vec![0,0,0,0,0], 0), vec![
                vec![0,0,0,0]
            ]);

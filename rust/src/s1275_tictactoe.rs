/*
 * @lc app=leetcode.cn id=1275 lang=rust
 *
 * [1275] 找出井字棋的获胜者
 */
...
impl Solution {
    pub fn tictactoe(moves: Vec<Vec<i32>>) -> String {
        // 我就不写了
        // refer:  https://github.com/ruislan/leetcode/blob/df09787718d007576cad6614101726c81d20f9c2/src/q/q1275.rs
        // 方法1
        ...
        for i in 0..moves.len() {
            board[moves[i][0] as usize][moves[i][1] as usize] =
